      ...
      <div className='main-container'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='input-area'>
            ...
            <input type='email' className='inputbox' onChange={(e) => setEmail(e.target.value)} placeholder='Enter your email' required/>
          </div>
          <div className='input-area'>
            <p className='input-text'>Username</p>
            <input type='text' className='inputbox' onChange={(e) => setUsername(e.target.value)} placeholder='Enter your username' required/>
          </div>
